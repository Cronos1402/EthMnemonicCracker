...
def cronos():
    ...
    while True:
        ...
        console.print(Panel(str(CronosPanel), title="[white]Ethereum Mnemonic Checker V1[/]",
                            subtitle="[green_yellow blink] @CRONOS1402 [/]", style="green"), style=style, justify="full")
...
if __name__ == '__main__':
    for i in range(len(add)):
        p = multiprocessing.Process(target=cronos)
        p.start()
        p.join()
